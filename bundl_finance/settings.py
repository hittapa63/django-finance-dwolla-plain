"""
Django settings for Bundl project.
...
SECRET_KEY = 'fCajBirumZsLTYFGtzIfnLYTtCpVTNMueBFBdxFe'
...
ROOT_URLCONF = 'bundl_finance.urls'
...
WSGI_APPLICATION = 'bundl_finance.wsgi.application'
